...
import com.nanyibang.commonview.transformer.BasePageTransformer;
...
public class XBanner extends RelativeLayout implements XBannerViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private boolean mPointerIsWrapContent;
    ...
    private void initCustomAttrs(Context context, AttributeSet attrs) {
        ...
        if (typedArray != null) {
            ...
            mPointerIsWrapContent = typedArray.getBoolean(R.styleable.XBanner_point_iswrapcontent,false);
            typedArray.recycle();
        }
    ...
    private void initView() {
        ...
        /*设定指示器容器布局及位置*/
        mPointContainerLp = new LayoutParams(mPointerIsWrapContent?RWC:RMP, RWC);
        //mPointContainerLp.topMargin = mPointContainerLp.height;
        if(mPointerIsWrapContent)mPointContainerLp.addRule(RelativeLayout.CENTER_IN_PARENT|RelativeLayout.ALIGN_PARENT_BOTTOM);
